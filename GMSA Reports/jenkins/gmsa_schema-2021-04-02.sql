...
CREATE TABLE IF NOT EXISTS `cdr_data_details_vw` (
  ...
  `STOP_TIME` datetime(6) NOT NULL DEFAULT '2019-01-01 00:00:00.000000',
...
) ENGINE=InnoDB AUTO_INCREMENT=55242 DEFAULT CHARSET=utf8 COMMENT='This table is used for storing the cdr data records of the IMSI';
...
-- Dumping structure for procedure gmsa_reports.gm_truncate_row_data
