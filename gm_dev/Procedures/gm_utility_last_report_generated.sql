...
-- Dumping structure for procedure gm_reports.gm_utility_last_report_generated
DELIMITER //
CREATE  PROCEDURE `gm_utility_last_report_generated`(IN `in_report_type` VARCHAR(50), IN `in_report_date` varchar(50)
