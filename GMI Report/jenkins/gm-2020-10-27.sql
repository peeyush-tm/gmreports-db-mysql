...
--   cdr_data_details_vw.SERVED_IMSI AS OPERATOR_NETWORK,
   ...
   case when cdr_data_details_vw.RAT_TYPE=1 then '3G' when cdr_data_details_vw.RAT_TYPE=6 then '4G' when cdr_data_details_vw.RAT_TYPE=2 then '2G' else '4G' end  AS CALL_TECHNOLOGY_TYPE,
